          ...
          if (isFluid) {
            ...
            <div class="row flex-center min-vh-100 py-6">
                <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4"><a class="d-flex flex-center mb-4 btn"
                        ...
                        <span class="font-sans-serif fw-bolder fs-5 d-inline-block text-green">Proxyxyou</span></a>
                    <div class="card">
                        {{-- alert --}}
...
{{--                                </div>--}}
                            ...
                            <form action="{{route('user.login')}}" method="POST">
                                ...
                                <div class="row flex-between-center">
                                    ...
                                    <div class="col-auto d-none"><a class="fs--1"
                                            href="../../../pages/authentication/simple/forgot-password.html">Forgot
                                            Password?</a></div>
                                </div>
                                <div class="mb-3">
                                    <button class="btn btn-green d-block w-100 mt-3" type="submit" name="submit">Log
                                        in</button>
                                </div>
                            </form>
